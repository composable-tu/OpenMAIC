...
// Pre-outline ask_user helpers: pure functions with no Node imports, safe to
// bundle into client components. Prompt construction and model parsing stay
// server-side in clarify.ts.
